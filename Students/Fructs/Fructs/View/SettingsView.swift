        ...
        NavigationView{
            ScrollView(.vertical, showsIndicators: false){
                VStack(spacing: 20) {
                    ...
                    GroupBox(label: SettingViewLabel(labelText: "Customization", labelImage: "paintbrush"))
                    {
                        Divider().padding(.vertical, 4)
                        Text("If you wish you can restart the application by toggle the switch in this box.That way it start the onbording preocess and you will see the welcome screen again.")
                            .padding(.vertical, 8)
                            .frame(minHeight : 60)
                            .layoutPriority(1)
                            .font(.footnote)
                    ...
                    //MARK: - SECTION-3
                    GroupBox(
                        label: SettingViewLabel(labelText: "Application", labelImage: "apps.iphone")
                    ){
                        Divider().padding(.vertical, 4)
                        SettingRowView(name: "Developer", content: "Arman Akash")
                        SettingRowView(name: "Developer", content: "Fahim Rahman")
                        }
